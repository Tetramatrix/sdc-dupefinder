...
/* harmony import */ var _src_fx_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/fx.css */ "./src/fx.css");

//const $ = window.$;
const {
  Component,
  render
} = wp.element; //import React, { Component } from 'react';
...
class PostList extends Component {
  ...
  componentDidUpdate() {
    ...
    window.jQuery("#scd_dupefinder img").on('error', function () {
  ...
  componentDidMount() {
    ...
    params.append('post_id', scd_dupefinder_obj.post_id); //console.log(params);

    axios__WEBPACK_IMPORTED_MODULE_1___default().post(scd_dupefinder_obj.ajax_url, params).then(response => {
      //debugger;
  ...
  render() {
    if (this.state.isLoaded == false) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["default"], {
        animation: "border",
        variant: "primary",
        role: "status"
      ...
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, this.state.posts.map(post => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
        class: "scd_post"
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: post.permalink
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, post.percentage, "%", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "match"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: post.permalink
      }, post.post_title), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Also contains: ", post.in_common.join(', '), " ... ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        href: post.permalink
      }, "See more"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        alt: "alt",
        href: post.permalink
...
const {
  Component,
  render
} = wp.element; //const Shows = React.lazy(() => PostList);
// Render the app inside our shortcode's #app div

render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_postList__WEBPACK_IMPORTED_MODULE_1__["default"], null), document.getElementById('scd_dupefinder'));
}();
/******/ })()
;
